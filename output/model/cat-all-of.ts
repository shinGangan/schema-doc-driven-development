...
export interface CatAllOf {
     ...
     * @memberof CatAllOf
     */
    'huntingSkill': CatAllOfHuntingSkillEnum;
}

export const CatAllOfHuntingSkillEnum = {
    Clueless: 'clueless',
    Lazy: 'lazy',
...
export type CatAllOfHuntingSkillEnum = typeof CatAllOfHuntingSkillEnum[keyof typeof CatAllOfHuntingSkillEnum];
